...
repo --name=qubes-r4.3 --gpgkey=file:///tmp/qubes-installer/qubes-release/RPM-GPG-KEY-qubes-4.3-primary --baseurl=http://yum.qubes-os.org/r4.3/current/host/fc41 --ignoregroups=true
